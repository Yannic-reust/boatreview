  ...
  <div id="impressum" >
    <Header-app v-bind:moblieView="moblieView"></Header-app>
        <div class="content">
            ...
            <p>Boat-Review<br/>Yannic Reust<br/>Blumenweg, 10<br/>3604 Thun<br/>Schweiz</p>
            <p>E-Mail:<br/><a href="mailto::yannic.reust@bluewin.ch">yannic.reust@bluewin.ch</a></p>
            <p>&nbsp;</p>
            <br>
            ...
            <p>Die Urheber- und alle anderen Rechte an Inhalten, Bildern, Fotos oder anderen Dateien auf dieser Website, geh&ouml;ren ausschliesslich <strong>Yannic Reust</strong> oder den speziell genannten Rechteinhabern. F&uuml;r die Reproduktion jeglicher Elemente ist die schriftliche Zustimmung des Urheberrechtstr&auml;gers im Voraus einzuholen.</p>
            <p>&nbsp;</p><!--ACHTUNG: Wenn Sie die Quelle ohne Erlaubnis von SwissAnwalt entfernen, dann begehen Sie eine Urheberrechtsverletzung welche in jedem Fall geahndet wird.--><br/>
            Quelle: <a href="https://www.swissanwalt.ch" target="_blank" rel="noopener">SwissAnwalt</a><!--Bitte beachten Sie die AGB von SwissAnwalt betreffend allf&auml;llig anfallenden Kosten bei Weglassen der Quelle!-->
...
<style src="./impressum.scss" lang="scss" scoped></style>
